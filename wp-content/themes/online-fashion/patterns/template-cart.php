...
/**
 * Title: Template Cart
 * Slug: online-fashion/template-cart
...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in', 'online-fashion' ); ?>…</h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php echo esc_html__( 'Your cart is currently empty!', 'online-fashion' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ));?>"><?php echo esc_html__( 'Browse store', 'online-fashion' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'online-fashion' ); ?></h2>
<!-- /wp:heading -->
